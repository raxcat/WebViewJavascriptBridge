...
#define WVJB_WEBVIEW_DELEGATE_TYPE NSObject<WebFrameLoadDelegate,WebResourceLoadDelegate,WebPolicyDelegate>
#define WVJB_WEBVIEW_DELEGATE_INTERFACE NSObject<WebFrameLoadDelegate,WebResourceLoadDelegate,WebPolicyDelegate>
